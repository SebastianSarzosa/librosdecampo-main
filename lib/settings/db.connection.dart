...
class DbConnection {
  ...
  static Future<Database> getDatabase() async {
    return openDatabase(join(await getDatabasesPath(), dbname),
        ...
        """),
              ...
              await db.execute("""
          INSERT INTO Controles (fecha_control,nombre_control, fkid_planta) VALUES
          ('2025-01-05','Control Inicial ', 1),
          ('2025-01-10','Control Semanal uno', 1),
          ('2025-01-15','Control Semanal dos',  1),
          ('2025-01-20','Control Semanal tres',  1),
          ('2025-01-25','Control Semanal cuatro',  1),
          ('2025-02-01','Control Semanal cinco',  1),
          ('2025-02-05','Control Semanal seis',  1),
          ('2025-02-10','Control Semanal siete',  1),
          ('2025-02-15','Control Semanal ocho',  1),
          ('2025-03-07','Control Semanal nueve', 1),
          ('2025-01-05','Control Inicial ',  2),
          ('2025-01-10','Control Semanal uno',  2),
          ('2025-01-15','Control Semanal dos',  2),
          ('2025-01-20','Control Semanal tres',  2),
          ('2025-01-25','Control Semanal cuatro', 2),
          ('2025-02-01','Control Semanal cinco', 2),
          ('2025-02-05','Control Semanal seis',  2),
          ('2025-02-10','Control Semanal siete', 2),
          ('2025-02-15','Control Semanal ocho', 2),
          ('2025-03-07','Control Semanal nueve',  2),
          ('2025-01-05','Control Inicial ',  3),
          ('2025-01-10','Control Semanal uno', 3),
          ('2025-01-15','Control Semanal dos',  3),
          ('2025-01-20','Control Semanal tres',  3),
          ('2025-01-25','Control Semanal cuatro', 3),
          ('2025-02-01','Control Semanal cinco', 3),
          ('2025-02-05','Control Semanal seis',  3),
          ('2025-02-10','Control Semanal siete', 3),
          ('2025-02-15','Control Semanal ocho', 3),
          ('2025-03-07','Control Semanal nueve',  3),
          ('2025-01-05','Control Inicial ',  4),
          ('2025-01-10','Control Semanal uno', 4),
          ('2025-01-15','Control Semanal dos',  4),
          ('2025-01-20','Control Semanal tres',  4),
          ('2025-01-25','Control Semanal cuatro', 4),
          ('2025-02-01','Control Semanal cinco', 4),
          ('2025-02-05','Control Semanal seis',  4),
          ('2025-02-10','Control Semanal siete', 4),
          ('2025-02-15','Control Semanal ocho', 4)
  ...
  static Future<int> updateControl(String tableName, dynamic data, int id) async {
    final db = await getDatabase();
    return db.update(tableName, data,
        where: "id_control = ?",
        whereArgs: [id],
